// part7/bloglist/backend/utils/test_helper.js
...
// Updated `addLoginUser` function to handle already existing user
const addLoginUser = async () => {
  const userExists = await User.findOne({ username: loginUser.username });
  if (!userExists) {
